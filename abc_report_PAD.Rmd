...
In the fall of 2016, Dr. Ryan Burge and Dr. Paul Djupe administered an online survey in clergy from the American Baptist Churches of the USA denomination. This survey was open from October 25th until November 7th. The opportunity to take the survey was offered through an email correspondence and the Qualtrics survey platform was used to pose the questions and record the results. In total 1314 emails were sent, but 289 bounced back. The total number of clergy who began the survey was 246, however there was a significant amount of roll-off - there were some questions where the number of respondents dropped to 168.
